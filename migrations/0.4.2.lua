...
--  settings.global["tsx-behaviour"] = {value = "switch-to-manual"}
--elseif global.config.apply_custom_conditions == true then
--  settings.global["tsx-behaviour"] = {value = "apply-custom-conditions"}
--end
--
--if global.config.remove_all == true or global.config.remove_other == true then
--  settings.global["tsx-removetemps"] = {value = true}
--  global.config.remove_all = true
--else
--  settings.global["tsx-removetemps"] = {value = false}
--  global.config.remove_all = false
--end
--
--global.config.search_radius = settings.global["tsx-searchradius"].value
